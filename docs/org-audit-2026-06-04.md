...
- [x] **8. Outside collaborator review (2026-06-04)**
  - _Removed:_ `aulakhznavreen`, `gohbi`, `JohnBuni`, `Kyle-Hawkins`, `msmel01`, `sarayyjaan`
  ...
  - _Kept:_ `sae-br` — active on `accessible-housing-portal`. Consider inviting to org.
  - _Remaining:_ `keriwarr`, `lcik` — read-only on public repos only. Verify and remove if not needed.

- [x] **9. Assign project teams to repos (2026-06-04)**
  ...
  - _No team yet:_ `accessible-housing-portal`, `project-pech`, `epwr_case_management` — under organizers fallback pending team creation
